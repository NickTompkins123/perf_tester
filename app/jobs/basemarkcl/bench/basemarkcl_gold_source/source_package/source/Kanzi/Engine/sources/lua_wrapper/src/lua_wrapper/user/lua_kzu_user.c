...
/* Exported function */
 int  tolua_kzu_user_open (lua_State* tolua_S);
...
/* function: kzuUserInitialize */
#ifndef TOLUA_DISABLE_tolua_kzu_user_kzuUserInitialize00
static int tolua_kzu_user_kzuUserInitialize00(lua_State* tolua_S)
{
...
#endif
 {
  ...
  {
   kzsError tolua_ret = (kzsError)  kzuUserInitialize(memoryManager);
   {
#ifdef __cplusplus
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'kzuUserInitialize'.",&tolua_err);
 return 0;
#endif
}
#endif /* #ifndef TOLUA_DISABLE */

/* function: kzuUserUninitialize */
#ifndef TOLUA_DISABLE_tolua_kzu_user_kzuUserUninitialize00
static int tolua_kzu_user_kzuUserUninitialize00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  {
   kzsError tolua_ret = (kzsError)  kzuUserUninitialize();
   {
#ifdef __cplusplus
    void* tolua_obj = Mtolua_new((kzsError)(tolua_ret));
     tolua_pushusertype(tolua_S,tolua_obj,"kzsError");
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'kzuUserUninitialize'.",&tolua_err);
 return 0;
#endif
}
#endif /* #ifndef TOLUA_DISABLE */
 ...
 int tolua_kzu_user_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_function(tolua_S,"kzuUserInitialize",tolua_kzu_user_kzuUserInitialize00);
  tolua_function(tolua_S,"kzuUserUninitialize",tolua_kzu_user_kzuUserUninitialize00);
 tolua_endmodule(tolua_S);
 return 1;
}
  ...
  int luaopen_kzu_user (lua_State* tolua_S) {
 return tolua_kzu_user_open(tolua_S);
}
#endif
