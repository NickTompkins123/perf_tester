...
/* Print supported extensions to kzcLog upon creation. */
/* #define PRINT_SUPPORTED_GPU_EXTENSIONS 1 */
...
kzsError kzcRendererCreate(const struct KzcMemoryManager* memoryManager, struct KzcRenderer** out_renderer)
{
    ...
    result = kzcMemoryAllocVariable(memoryManager, renderer, "RendererGL21");
...
static kzsError kzcRendererExtensionInitialize_internal(struct KzcRenderer* renderer)
{
#ifdef WIN32
    kzInt i;
    kzInt openGlVersion[2]; /* [0] = Major, [1] = Minor. */
    kzsError result;
    kzString extensionString;
    const kzString KZC_EXTENSIONS[KZC_EXTENSION_COUNT] =
    {
    ...
    {
        kzInt glVersionIndex = 0;
        kzString version;
        kzString p;
        kzMutableString versionString;
        version = kzsGlGetString(KZS_GL_VERSION);
        result = kzcStringCopy(kzcMemoryGetManager(renderer), version, &versionString);
        kzsErrorForward(result);
        p = kzsStrtok(versionString, ".");
        while(glVersionIndex < 2)
        {
            openGlVersion[glVersionIndex] = kzsAtoi(p);
            p = strtok(KZ_NULL, ".");
            glVersionIndex++;
        }
    ...
    {
        kzUint index;
        renderer->supportedExtensions[i] = kzcStringFindSubstring(extensionString, KZC_EXTENSIONS[i], &index);

        if(renderer->supportedExtensions[i])
        {
#ifdef PRINT_SUPPORTED_GPU_EXTENSIONS
    ...
    /* If OpenGL Version is high enough. */
    kzsErrorTest(openGlVersion[0] >= 3, KZS_ERROR_DISPLAY_OPENGL2_NOT_SUPPORTED, "OpenGL 2.1 not supported by the platform.");
    kzsErrorTest(renderer->supportedExtensions[KZC_GL_ARB_framebuffer_object], KZS_ERROR_DISPLAY_OPENGL2_NOT_SUPPORTED, "GL_ARB_framebuffer_object extension not supported by the platform.");

    /* Load extension functions. */
    glIsRenderbuffer = (PFNGLISRENDERBUFFERPROC)kzsGLGetProcAddress("glIsRenderbuffer");

    /* KZC_GL_ARB_framebuffer_object */
    glBindRenderbuffer = (PFNGLBINDRENDERBUFFERPROC)kzsGLGetProcAddress("glBindRenderbuffer");
    glDeleteRenderbuffers = (PFNGLDELETERENDERBUFFERSPROC)kzsGLGetProcAddress("glDeleteRenderbuffers");
    glGenRenderbuffers = (PFNGLGENRENDERBUFFERSPROC)kzsGLGetProcAddress("glGenRenderbuffers");
    glRenderbufferStorage = (PFNGLRENDERBUFFERSTORAGEPROC)kzsGLGetProcAddress("glRenderbufferStorage");
    glGetRenderbufferParameteriv = (PFNGLGETRENDERBUFFERPARAMETERIVPROC)kzsGLGetProcAddress("glGetRenderbufferParameteriv");
    glIsFramebuffer = (PFNGLISFRAMEBUFFERPROC)kzsGLGetProcAddress("glIsFramebuffer");
    glBindFramebuffer = (PFNGLBINDFRAMEBUFFERPROC)kzsGLGetProcAddress("glBindFramebuffer");
    glDeleteFramebuffers = (PFNGLDELETEFRAMEBUFFERSPROC)kzsGLGetProcAddress("glDeleteFramebuffers");
    glGenFramebuffers = (PFNGLGENFRAMEBUFFERSPROC)kzsGLGetProcAddress("glGenFramebuffers");
    glCheckFramebufferStatus = (PFNGLCHECKFRAMEBUFFERSTATUSPROC)kzsGLGetProcAddress("glCheckFramebufferStatus");
    glFramebufferTexture1D = (PFNGLFRAMEBUFFERTEXTURE1DPROC)kzsGLGetProcAddress("glFramebufferTexture1D");
    glFramebufferTexture2D = (PFNGLFRAMEBUFFERTEXTURE2DPROC)kzsGLGetProcAddress("glFramebufferTexture2D");
    glFramebufferTexture3D = (PFNGLFRAMEBUFFERTEXTURE3DPROC)kzsGLGetProcAddress("glFramebufferTexture3D");
    glFramebufferRenderbuffer = (PFNGLFRAMEBUFFERRENDERBUFFERPROC)kzsGLGetProcAddress("glFramebufferRenderbuffer");
    glGetFramebufferAttachmentParameteriv = (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC)kzsGLGetProcAddress("glGetFramebufferAttachmentParameteriv");
    glGenerateMipmap = (PFNGLGENERATEMIPMAPPROC)kzsGLGetProcAddress("glGenerateMipmap");
    glBlitFramebuffer = (PFNGLBLITFRAMEBUFFERPROC)kzsGLGetProcAddress("glBlitFramebuffer");
    glRenderbufferStorageMultisample = (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC)kzsGLGetProcAddress("glRenderbufferStorageMultisample");
    glFramebufferTextureLayer = (PFNGLFRAMEBUFFERTEXTURELAYERPROC)kzsGLGetProcAddress("glFramebufferTextureLayer");

    /* GL_VERSION_1_2 */
    glBlendColor = (PFNGLBLENDCOLORPROC)kzsGLGetProcAddress("glBlendColor");
    glBlendEquation = (PFNGLBLENDEQUATIONPROC)kzsGLGetProcAddress("glBlendEquation");
    glDrawRangeElements = (PFNGLDRAWRANGEELEMENTSPROC)kzsGLGetProcAddress("glDrawRangeElements");
    glTexImage3D = (PFNGLTEXIMAGE3DPROC)kzsGLGetProcAddress("glTexImage3D");
    glTexSubImage3D = (PFNGLTEXSUBIMAGE3DPROC)kzsGLGetProcAddress("glTexSubImage3D");
    glCopyTexSubImage3D = (PFNGLCOPYTEXSUBIMAGE3DPROC)kzsGLGetProcAddress("glCopyTexSubImage3D");
     
    /* GL_VERSION_1_3 */
    glActiveTexture = (PFNGLACTIVETEXTUREPROC)kzsGLGetProcAddress("glActiveTexture");
    glSampleCoverage = (PFNGLSAMPLECOVERAGEPROC)kzsGLGetProcAddress("glSampleCoverage");
    glCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3DPROC)kzsGLGetProcAddress("glCompressedTexImage3D");
    glCompressedTexImage2D = (PFNGLCOMPRESSEDTEXIMAGE2DPROC)kzsGLGetProcAddress("glCompressedTexImage2D");
    glCompressedTexImage1D = (PFNGLCOMPRESSEDTEXIMAGE1DPROC)kzsGLGetProcAddress("glCompressedTexImage1D");
    glCompressedTexSubImage3D = (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC)kzsGLGetProcAddress("glCompressedTexSubImage3D");
    glCompressedTexSubImage2D = (PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC)kzsGLGetProcAddress("glCompressedTexSubImage2D");
    glCompressedTexSubImage1D = (PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC)kzsGLGetProcAddress("glCompressedTexSubImage1D");
    glGetCompressedTexImage = (PFNGLGETCOMPRESSEDTEXIMAGEPROC)kzsGLGetProcAddress("glGetCompressedTexImage");
     
    /* GL_VERSION_1_4 */
    glBlendFuncSeparate = (PFNGLBLENDFUNCSEPARATEPROC)kzsGLGetProcAddress("glBlendFuncSeparate");
    glMultiDrawArrays = (PFNGLMULTIDRAWARRAYSPROC)kzsGLGetProcAddress("glMultiDrawArrays");
    glMultiDrawElements = (PFNGLMULTIDRAWELEMENTSPROC)kzsGLGetProcAddress("glMultiDrawElements");
    glPointParameterf = (PFNGLPOINTPARAMETERFPROC)kzsGLGetProcAddress("glPointParameterf");
    glPointParameterfv = (PFNGLPOINTPARAMETERFVPROC)kzsGLGetProcAddress("glPointParameterfv");
    glPointParameteri = (PFNGLPOINTPARAMETERIPROC)kzsGLGetProcAddress("glPointParameteri");
    glPointParameteriv = (PFNGLPOINTPARAMETERIVPROC)kzsGLGetProcAddress("glPointParameteriv");
     
    /* GL_VERSION_1_5 */
    glBindBuffer = (PFNGLBINDBUFFERPROC)kzsGLGetProcAddress("glBindBuffer");
    glDeleteBuffers = (PFNGLDELETEBUFFERSPROC)kzsGLGetProcAddress("glDeleteBuffers");
    glGenBuffers = (PFNGLGENBUFFERSPROC)kzsGLGetProcAddress("glGenBuffers");
    glIsBuffer = (PFNGLISBUFFERPROC)kzsGLGetProcAddress("glIsBuffer");
    glBufferData = (PFNGLBUFFERDATAPROC)kzsGLGetProcAddress("glBufferData");
    glBufferSubData = (PFNGLBUFFERSUBDATAPROC)kzsGLGetProcAddress("glBufferSubData");
    glGetBufferSubData = (PFNGLGETBUFFERSUBDATAPROC)kzsGLGetProcAddress("glGetBufferSubData");
    glMapBuffer = (PFNGLMAPBUFFERPROC)kzsGLGetProcAddress("glMapBuffer");
    glUnmapBuffer = (PFNGLUNMAPBUFFERPROC)kzsGLGetProcAddress("glUnmapBuffer");
    glGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIVPROC)kzsGLGetProcAddress("glGetBufferParameteriv");
    glGetBufferPointerv = (PFNGLGETBUFFERPOINTERVPROC)kzsGLGetProcAddress("glGetBufferPointerv");
    
    /* GL_VERSION_2_0 */
    glBlendEquationSeparate = (PFNGLBLENDEQUATIONSEPARATEPROC)kzsGLGetProcAddress("glBlendEquationSeparate");
    glDrawBuffers = (PFNGLDRAWBUFFERSPROC)kzsGLGetProcAddress("glDrawBuffers");
    glStencilOpSeparate = (PFNGLSTENCILOPSEPARATEPROC)kzsGLGetProcAddress("glStencilOpSeparate");
    glStencilFuncSeparate = (PFNGLSTENCILFUNCSEPARATEPROC)kzsGLGetProcAddress("glStencilFuncSeparate");
    glStencilMaskSeparate = (PFNGLSTENCILMASKSEPARATEPROC)kzsGLGetProcAddress("glStencilMaskSeparate");
    glAttachShader = (PFNGLATTACHSHADERPROC)kzsGLGetProcAddress("glAttachShader");
    glBindAttribLocation = (PFNGLBINDATTRIBLOCATIONPROC)kzsGLGetProcAddress("glBindAttribLocation");
    glCompileShader = (PFNGLCOMPILESHADERPROC)kzsGLGetProcAddress("glCompileShader");
    glCreateProgram = (PFNGLCREATEPROGRAMPROC)kzsGLGetProcAddress("glCreateProgram");
    glCreateShader = (PFNGLCREATESHADERPROC)kzsGLGetProcAddress("glCreateShader");
    glDeleteProgram = (PFNGLDELETEPROGRAMPROC)kzsGLGetProcAddress("glDeleteProgram");
    glDeleteShader = (PFNGLDELETESHADERPROC)kzsGLGetProcAddress("glDeleteShader");
    glDetachShader = (PFNGLDETACHSHADERPROC)kzsGLGetProcAddress("glDetachShader");
    glDisableVertexAttribArray = (PFNGLDISABLEVERTEXATTRIBARRAYPROC)kzsGLGetProcAddress("glDisableVertexAttribArray");
    glEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC)kzsGLGetProcAddress("glEnableVertexAttribArray");
    glGetActiveAttrib = (PFNGLGETACTIVEATTRIBPROC)kzsGLGetProcAddress("glGetActiveAttrib");
    glGetActiveUniform = (PFNGLGETACTIVEUNIFORMPROC)kzsGLGetProcAddress("glGetActiveUniform");
    glGetAttachedShaders = (PFNGLGETATTACHEDSHADERSPROC)kzsGLGetProcAddress("glGetAttachedShaders");
    glGetAttribLocation = (PFNGLGETATTRIBLOCATIONPROC)kzsGLGetProcAddress("glGetAttribLocation");
    glGetProgramiv = (PFNGLGETPROGRAMIVPROC)kzsGLGetProcAddress("glGetProgramiv");
    glGetProgramInfoLog = (PFNGLGETPROGRAMINFOLOGPROC)kzsGLGetProcAddress("glGetProgramInfoLog");
    glGetShaderiv = (PFNGLGETSHADERIVPROC)kzsGLGetProcAddress("glGetShaderiv");
    glGetShaderInfoLog = (PFNGLGETSHADERINFOLOGPROC)kzsGLGetProcAddress("glGetShaderInfoLog");
    glGetShaderSource = (PFNGLGETSHADERSOURCEPROC)kzsGLGetProcAddress("glGetShaderSource");
    glGetUniformLocation = (PFNGLGETUNIFORMLOCATIONPROC)kzsGLGetProcAddress("glGetUniformLocation");
    glGetUniformfv = (PFNGLGETUNIFORMFVPROC)kzsGLGetProcAddress("glGetUniformfv");
    glGetUniformiv = (PFNGLGETUNIFORMIVPROC)kzsGLGetProcAddress("glGetUniformiv");
    glGetVertexAttribdv = (PFNGLGETVERTEXATTRIBDVPROC)kzsGLGetProcAddress("glGetVertexAttribdv");
    glGetVertexAttribfv = (PFNGLGETVERTEXATTRIBFVPROC)kzsGLGetProcAddress("glGetVertexAttribfv");
    glGetVertexAttribiv = (PFNGLGETVERTEXATTRIBIVPROC)kzsGLGetProcAddress("glGetVertexAttribiv");
    glGetVertexAttribPointerv = (PFNGLGETVERTEXATTRIBPOINTERVPROC)kzsGLGetProcAddress("glGetVertexAttribPointerv");
    glIsProgram = (PFNGLISPROGRAMPROC)kzsGLGetProcAddress("glIsProgram");
    glIsShader = (PFNGLISSHADERPROC)kzsGLGetProcAddress("glIsShader");
    glLinkProgram = (PFNGLLINKPROGRAMPROC)kzsGLGetProcAddress("glLinkProgram");
    glShaderSource = (PFNGLSHADERSOURCEPROC)kzsGLGetProcAddress("glShaderSource");
    glUseProgram = (PFNGLUSEPROGRAMPROC)kzsGLGetProcAddress("glUseProgram");
    glUniform1f = (PFNGLUNIFORM1FPROC)kzsGLGetProcAddress("glUniform1f");
    glUniform2f = (PFNGLUNIFORM2FPROC)kzsGLGetProcAddress("glUniform2f");
    glUniform3f = (PFNGLUNIFORM3FPROC)kzsGLGetProcAddress("glUniform3f");
    glUniform4f = (PFNGLUNIFORM4FPROC)kzsGLGetProcAddress("glUniform4f");
    glUniform1i = (PFNGLUNIFORM1IPROC)kzsGLGetProcAddress("glUniform1i");
    glUniform2i = (PFNGLUNIFORM2IPROC)kzsGLGetProcAddress("glUniform2i");
    glUniform3i = (PFNGLUNIFORM3IPROC)kzsGLGetProcAddress("glUniform3i");
    glUniform4i = (PFNGLUNIFORM4IPROC)kzsGLGetProcAddress("glUniform4i");
    glUniform1fv = (PFNGLUNIFORM1FVPROC)kzsGLGetProcAddress("glUniform1fv");
    glUniform2fv = (PFNGLUNIFORM2FVPROC)kzsGLGetProcAddress("glUniform2fv");
    glUniform3fv = (PFNGLUNIFORM3FVPROC)kzsGLGetProcAddress("glUniform3fv");
    glUniform4fv = (PFNGLUNIFORM4FVPROC)kzsGLGetProcAddress("glUniform4fv");
    glUniform1iv = (PFNGLUNIFORM1IVPROC)kzsGLGetProcAddress("glUniform1iv");
    glUniform2iv = (PFNGLUNIFORM2IVPROC)kzsGLGetProcAddress("glUniform2iv");
    glUniform3iv = (PFNGLUNIFORM3IVPROC)kzsGLGetProcAddress("glUniform3iv");
    glUniform4iv = (PFNGLUNIFORM4IVPROC)kzsGLGetProcAddress("glUniform4iv");
    glUniformMatrix2fv = (PFNGLUNIFORMMATRIX2FVPROC)kzsGLGetProcAddress("glUniformMatrix2fv");
    glUniformMatrix3fv = (PFNGLUNIFORMMATRIX3FVPROC)kzsGLGetProcAddress("glUniformMatrix3fv");
    glUniformMatrix4fv = (PFNGLUNIFORMMATRIX4FVPROC)kzsGLGetProcAddress("glUniformMatrix4fv");
    glValidateProgram = (PFNGLVALIDATEPROGRAMPROC)kzsGLGetProcAddress("glValidateProgram");
    glVertexAttrib1d = (PFNGLVERTEXATTRIB1DPROC)kzsGLGetProcAddress("glVertexAttrib1d");
    glVertexAttrib1dv = (PFNGLVERTEXATTRIB1DVPROC)kzsGLGetProcAddress("glVertexAttrib1dv");
    glVertexAttrib1f = (PFNGLVERTEXATTRIB1FPROC)kzsGLGetProcAddress("glVertexAttrib1f");
    glVertexAttrib1fv = (PFNGLVERTEXATTRIB1FVPROC)kzsGLGetProcAddress("glVertexAttrib1fv");
    glVertexAttrib1s = (PFNGLVERTEXATTRIB1SPROC)kzsGLGetProcAddress("glVertexAttrib1s");
    glVertexAttrib1sv = (PFNGLVERTEXATTRIB1SVPROC)kzsGLGetProcAddress("glVertexAttrib1sv");
    glVertexAttrib2d = (PFNGLVERTEXATTRIB2DPROC)kzsGLGetProcAddress("glVertexAttrib2d");
    glVertexAttrib2dv = (PFNGLVERTEXATTRIB2DVPROC)kzsGLGetProcAddress("glVertexAttrib2dv");
    glVertexAttrib2f = (PFNGLVERTEXATTRIB2FPROC)kzsGLGetProcAddress("glVertexAttrib2f");
    glVertexAttrib2fv = (PFNGLVERTEXATTRIB2FVPROC)kzsGLGetProcAddress("glVertexAttrib2fv");
    glVertexAttrib2s = (PFNGLVERTEXATTRIB2SPROC)kzsGLGetProcAddress("glVertexAttrib2s");
    glVertexAttrib2sv = (PFNGLVERTEXATTRIB2SVPROC)kzsGLGetProcAddress("glVertexAttrib2sv");
    glVertexAttrib3d = (PFNGLVERTEXATTRIB3DPROC)kzsGLGetProcAddress("glVertexAttrib3d");
    glVertexAttrib3dv = (PFNGLVERTEXATTRIB3DVPROC)kzsGLGetProcAddress("glVertexAttrib3dv");
    glVertexAttrib3f = (PFNGLVERTEXATTRIB3FPROC)kzsGLGetProcAddress("glVertexAttrib3f");
    glVertexAttrib3fv = (PFNGLVERTEXATTRIB3FVPROC)kzsGLGetProcAddress("glVertexAttrib3fv");
    glVertexAttrib3s = (PFNGLVERTEXATTRIB3SPROC)kzsGLGetProcAddress("glVertexAttrib3s");
    glVertexAttrib3sv = (PFNGLVERTEXATTRIB3SVPROC)kzsGLGetProcAddress("glVertexAttrib3sv");
    glVertexAttrib4Nbv = (PFNGLVERTEXATTRIB4NBVPROC)kzsGLGetProcAddress("glVertexAttrib4Nbv");
    glVertexAttrib4Niv = (PFNGLVERTEXATTRIB4NIVPROC)kzsGLGetProcAddress("glVertexAttrib4Niv");
    glVertexAttrib4Nsv = (PFNGLVERTEXATTRIB4NSVPROC)kzsGLGetProcAddress("glVertexAttrib4Nsv");
    glVertexAttrib4Nub = (PFNGLVERTEXATTRIB4NUBPROC)kzsGLGetProcAddress("glVertexAttrib4Nub");
    glVertexAttrib4Nubv = (PFNGLVERTEXATTRIB4NUBVPROC)kzsGLGetProcAddress("glVertexAttrib4Nubv");
    glVertexAttrib4Nuiv = (PFNGLVERTEXATTRIB4NUIVPROC)kzsGLGetProcAddress("glVertexAttrib4Nuiv");
    glVertexAttrib4Nusv = (PFNGLVERTEXATTRIB4NUSVPROC)kzsGLGetProcAddress("glVertexAttrib4Nusv");
    glVertexAttrib4bv = (PFNGLVERTEXATTRIB4BVPROC)kzsGLGetProcAddress("glVertexAttrib4bv");
    glVertexAttrib4d = (PFNGLVERTEXATTRIB4DPROC)kzsGLGetProcAddress("glVertexAttrib4d");
    glVertexAttrib4dv = (PFNGLVERTEXATTRIB4DVPROC)kzsGLGetProcAddress("glVertexAttrib4dv");
    glVertexAttrib4f = (PFNGLVERTEXATTRIB4FPROC)kzsGLGetProcAddress("glVertexAttrib4f");
    glVertexAttrib4fv = (PFNGLVERTEXATTRIB4FVPROC)kzsGLGetProcAddress("glVertexAttrib4fv");
    glVertexAttrib4iv = (PFNGLVERTEXATTRIB4IVPROC)kzsGLGetProcAddress("glVertexAttrib4iv");
    glVertexAttrib4s = (PFNGLVERTEXATTRIB4SPROC)kzsGLGetProcAddress("glVertexAttrib4s");
    glVertexAttrib4sv = (PFNGLVERTEXATTRIB4SVPROC)kzsGLGetProcAddress("glVertexAttrib4sv");
    glVertexAttrib4ubv = (PFNGLVERTEXATTRIB4UBVPROC)kzsGLGetProcAddress("glVertexAttrib4ubv");
    glVertexAttrib4uiv = (PFNGLVERTEXATTRIB4UIVPROC)kzsGLGetProcAddress("glVertexAttrib4uiv");
    glVertexAttrib4usv = (PFNGLVERTEXATTRIB4USVPROC)kzsGLGetProcAddress("glVertexAttrib4usv");
    glVertexAttribPointer = (PFNGLVERTEXATTRIBPOINTERPROC)kzsGLGetProcAddress("glVertexAttribPointer");
     
    /* GL_VERSION_2_1 */
    glUniformMatrix2x3fv = (PFNGLUNIFORMMATRIX2X3FVPROC)kzsGLGetProcAddress("glUniformMatrix2x3fv");
    glUniformMatrix3x2fv = (PFNGLUNIFORMMATRIX3X2FVPROC)kzsGLGetProcAddress("glUniformMatrix3x2fv");
    glUniformMatrix2x4fv = (PFNGLUNIFORMMATRIX2X4FVPROC)kzsGLGetProcAddress("glUniformMatrix2x4fv");
    glUniformMatrix4x2fv = (PFNGLUNIFORMMATRIX4X2FVPROC)kzsGLGetProcAddress("glUniformMatrix4x2fv");
    glUniformMatrix3x4fv = (PFNGLUNIFORMMATRIX3X4FVPROC)kzsGLGetProcAddress("glUniformMatrix3x4fv");
    glUniformMatrix4x3fv = (PFNGLUNIFORMMATRIX4X3FVPROC)kzsGLGetProcAddress("glUniformMatrix4x3fv");
#endif
    kzsSuccess();
}
...
{
/* TODO: Consider what to do with this. Depth setting is not supported in OpenGL unless ARB ES Compatibility extension is available. */
#if 0
...
void kzcRendererSetVertexArrayData(const struct KzcRenderer* renderer, kzUint vertexArrayFlag, const void* data)
{
    ...
    if((vertexArrayFlag & KZC_VERTEX_ARRAY_POSITION) != 0)
    {
        ...
        {
            kzsAssertText(KZ_FALSE, "Position not found from shader when applying vertex array!");
        }
    }
    else if((vertexArrayFlag & KZC_VERTEX_ARRAY_NORMAL) != 0)
    {
        ...
        {
            kzsAssertText(KZ_FALSE, "Normals not found from shader when applying vertex array!");
        }
    }
    else if((vertexArrayFlag & KZC_VERTEX_ARRAY_TEXTURE_COORDINATE) != 0)
    {
        ...
        {
            kzsAssertText(KZ_FALSE, "Texture coordinates not found from shader when applying vertex array!");
        }
    }
    else if((vertexArrayFlag & KZC_VERTEX_ARRAY_COLOR) != 0)
    {
        ...
        {
            kzsAssertText(KZ_FALSE, "Colors not found from shader when applying vertex array!");
        }
    }
}
...
void kzcRendererGetViewport(const struct KzcRenderer* renderer, kzFloat* x, kzFloat* y, kzFloat* width, kzFloat* height)
{
    ...
    *x = (kzFloat)(kzInt)renderer->viewport.x;
    *y = (kzFloat)(kzInt)renderer->viewport.y;
    *width = (kzFloat)(kzInt)renderer->viewport.width;
    *height = (kzFloat)(kzInt)renderer->viewport.height;
}
